...
const config = {
  ...
  organizationName: 'Mr-LeeB', // Usually your GitHub org/user name.
  ...
  themeConfig:
    ...
    ({
      announcementBar: {
        ...
        content: `⭐️ If you like Apiato, give it a star on <a target="_blank" rel="noopener noreferrer" href="https://github.com/Mr-LeeB/documentation">GitHub</a>`,
      },
      docs: {
        sidebar: {
          hideable: true
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'GitHub Issues',
                href: 'https://github.com/Mr-LeeB/documentation/issues',
              },
            ],
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                href: 'https://github.com/Mr-LeeB/documentation/blob/9.0/CODE_OF_CONDUCT.md',
              },
            ],
          },
          {
            ...
            items: [
              {
                label: 'Our Sponsors',
                href: 'https://github.com/Mr-LeeB/documentation#sponsors',
              },
              {
